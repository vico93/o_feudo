/*
 *  Arquivo:				of_grove4l.pwn
 *  Tipo:					Filterscript para adicionar o carro do Sweet na groove
 *  Autor:					Vico
 *  Licença:				MIT
*/
...
#define	FS_NAME "GROVE4L"							// Nome do FilterScript

/* ------------------------------- BIBLIOTECAS ------------------------------- */
#include <a_samp>									// Biblioteca padrão

/* ---------------------------- VARIÁVEIS GLOBAIS ---------------------------- */
new sweet_greenwood = INVALID_VEHICLE_ID;			// Armazenará a ID do Greenwood
...
{
	// Destrói o Greenwood, se existir
	if (sweet_greenwood != INVALID_VEHICLE_ID)
	{
		DestroyVehicle(sweet_greenwood);
	}	
