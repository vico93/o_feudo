...
public OnFilterScriptInit()
{
	...
	TextDrawAlignment(clock_hud, TEXT_DRAW_ALIGN_CENTER);
	TextDrawColour(clock_hud, -1);
	TextDrawBackgroundColour(clock_hud, 255);
	TextDrawBoxColour(clock_hud, 50);
	TextDrawUseBox(clock_hud, false);
	TextDrawSetProportional(clock_hud, true);
	TextDrawSetSelectable(clock_hud, false);
